      ...
      `}} />
            ...
            <div style={{ position: 'relative', zIndex: 1, maxWidth: '800px' }}>
                ...
                <p className="animate-text delay-3" style={{
                    ...
                    The page you wanted is not here right now. It may have moved, changed, or dropped out of the stack before you reached it.
                </p>
