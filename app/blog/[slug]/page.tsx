...
export async function generateMetadata(
    ...
    return {
        ...
        keywords: [post.category, 'JewelSliding blog', 'puzzle article', post.title],
        alternates: {
...
export default async function BlogPostPage({
    ...
    const articleSchema = {
        ...
        author: {
            '@type': 'Organization',
            name: 'JewelSliding Editorial Team',
        },
        publisher: {
            '@type': 'Organization',
            name: 'JewelSliding',
        ...
        mainEntityOfPage: 'https://jewelsliding.com/blog/' + post.slug,
    };
    ...
    return (
        <>
            ...
            <div className="page-content">
                ...
                >
                    <div>
                        <h2 style={{ margin: 0, fontSize: '1.1rem' }}>Ready to try the idea in a live round?</h2>
                        <p style={{ margin: '0.5rem 0 0', color: 'var(--text-secondary)' }}>
                            Jump back into JewelSliding and use the next board to test what you just read.
                        </p>
                    </div>
